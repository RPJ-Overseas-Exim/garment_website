    ...
    <main className="shipping-policy">
      <div className="m-[auto] mt-[2rem] mb-[2rem] w-[80%]">
        ...
        <div className="mt-3 mb-3 font-[600] text-[var(--text-regular)] text-lg">
          <b>Your Clothes Store</b> is offering their customers two different
        ...
        <div className="mt-3 mb-3 font-[600] text-[var(--text-regular)] text-lg">
          <ul className="flex flex-col gap-y-3 list-decimal pl-7">
            <li>
              <b>Global Shipping: </b> With Global Shipping, clothes are shipped
            ...
            <li>
              <b>USA Premium Shipping: </b> In USA Premium Shipping, clothes are
        ...
        <div className="mt-3 mb-3 font-[600] text-[var(--text-regular)] text-lg">
          ...
          <p className="mt-2 mb-2 pl-7 flex flex-col">
            <span>Phone: +1 713 893 7357 </span>
            <span>benzosupplies.usatousa@gmail.com</span>
          </p>
        </div>
      </div>
    </main>
